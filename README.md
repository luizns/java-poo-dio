<h1> Prática Programação Orientada a Objetos - DIO</h1>

<p> 💎 prática de uma  das principais ferramentas da OO: <strong>ABSTRAÇÃO, ENCAPSULAMENTO, HERANÇA E POLIMORFISMO,</strong> através de um projeto Java. </p>
...
Disponibilizado  por [Camila Cavalcante - Dio](https://github.com/cami-la/desafio-poo-dio "cami-la").